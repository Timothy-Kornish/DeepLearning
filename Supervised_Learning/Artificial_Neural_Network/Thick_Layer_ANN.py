...
classifier.add(Dense(activation="relu", input_dim=11,
                     units=25, kernel_initializer="uniform"))
...
#-------------------------------------------------------------------------------
"""
Doubling the amount of nodes per layer (12 nodes per layer now) increased the accuracy by 2.5%

Increased from 6  to 12 nodes => 83.5% -> 86%
Increased from 12 to 15 nodes => 86% -> 86.6%
Increased from 15 to 25 nodes => 86.6% -> 88%
"""
