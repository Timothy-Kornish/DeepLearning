...
from keras.layers import Dense, Dropout # for layers of ANN
from keras.wrappers.scikit_learn import KerasClassifier # for wrapping k-fold cross validation
...
cv_classifier = KerasClassifier(build_fn = build_classifier, batch_size = 10, nb_epoch = 100)
print('Build Done')
accuracies = cross_val_score(estimator = cv_classifier, X = x_train, y = y_train, cv = 10)
# n_jobs = -1 means use all cpu's, n_jobs = number of CPUs
# for some reason n_jobs causes the program to crash so it was taken out of accuracies
mean = accuracies.mean()
print('Mean Accuracy of ANN: ', mean)
variance = accuracies.std()
print('Variance of Accuracy of ANN', variance)

#-------------------------------------------------------------------------------
#                           Grid Search tuning of ANN
#-------------------------------------------------------------------------------
...
grid_search = GridSearchCV(estimator = grid_search_classifier,
